            ...
            try {
                ...
                if (!$emailExists) {
                    ...
                    if ($stmt->fetchColumn() > 0) {
                        ...
                        $stmt = $cnx->prepare("INSERT INTO USER (username, email, password, phone, last_name, first_name, is_verified) VALUES (?, ?, ?, ?, ?, ?, ?)");
                        $stmt->execute([$username, $_SESSION['email'], $password_hashed, null, null, null, 0]);
                ...
                error_log("creation DB error: " . $e->getMessage());

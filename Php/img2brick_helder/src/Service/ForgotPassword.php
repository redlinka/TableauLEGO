...
$email = trim($_SESSION['user_obj']->email ?? '');
if ($email === '') {
    header("Location: ../../public/account.php?error=Please provide your email");
    exit;
}
...
try {
    ...
    if (!$user) {
        ...
        header("Location: ../../public/account.php?success=If your email exists, you will receive reset instructions");
        exit;
    }

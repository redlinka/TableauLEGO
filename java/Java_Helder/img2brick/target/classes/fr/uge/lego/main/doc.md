...
*fr.uge.univ_eiffel.Main (``fr.uge.lego.main``)*
- fr.uge.univ_eiffel.Main.java : Point d’entrée de l’application, permettant de configurer les chemins d’images et les stratégies d’interpolation avant d’exécuter le programme.
...
- Ouvrir le fichier fr.uge.univ_eiffel.Main.java dans le package fr.uge.lego.main.
